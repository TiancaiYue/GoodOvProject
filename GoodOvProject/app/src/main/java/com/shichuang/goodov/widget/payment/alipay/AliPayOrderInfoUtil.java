package com.shichuang.goodov.widget.payment.alipay;
...
public class AliPayOrderInfoUtil {
     ...
     * @return
     */
    public static String buildOrderParamStringV1(String PID, String seller, String tradeNo, String name, String price, String detail, String notifyUrl) {
        String orderInfo = "partner=\"" + PID + "\"";
        orderInfo = orderInfo + "&seller_id=\"" + seller + "\"";
        orderInfo = orderInfo + "&out_trade_no=\"" + tradeNo + "\"";
        orderInfo = orderInfo + "&subject=\"" + detail + "\"";
        orderInfo = orderInfo + "&body=\"" + name + "\"";
        orderInfo = orderInfo + "&total_fee=\"" + price + "\"";
        orderInfo = orderInfo + "&notify_url=\"" + notifyUrl + "\"";
