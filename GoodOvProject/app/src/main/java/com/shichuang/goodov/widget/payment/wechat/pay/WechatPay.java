...
public class WechatPay {
    ...
    public void doPay(String pay_param, WXPayResultCallBack callback) {
        ...
        Log.d("test", "appid:" + param.optString("appid") + "\npartnerid:" + param.optString("partnerid") + "\nprepayid:" + param.optString("prepayid") + "\npackageValue:" + param.optString("packageValue") + "\nnoncestr:" + param.optString("noncestr") + "\ntimestamp:" + param.optString("timestamp") + "\nsign:" + param.optString("sign"));
